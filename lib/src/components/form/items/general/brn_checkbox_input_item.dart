...
class BrnCheckboxInputFormItem extends StatefulWidget {
  final String label;
  ...
  /// 选项选中状态变化回调
  final Function(bool oldValue, bool newValue) onChanged;

  /// form配置
  BrnFormItemConfig themeData;

  BrnCheckboxInputFormItem({
    Key key,
    this.label,
    this.title: "",
    this.subTitle,
  ...
  BrnCheckboxInputFormItem.autoLayout(
      {Key key,
      this.label,
      this.title: "",
      this.subTitle,
  ...
  @override
  BrnCheckboxInputFormItemState createState() {
    return BrnCheckboxInputFormItemState();
  }
}
...
class BrnCheckboxInputFormItemState extends State<BrnCheckboxInputFormItem> {
  @override
  ...
  double _getTitleMaxWidth(BuildContext context, BoxConstraints constraints) {
    ...
    double maxWidth = min(constraints.maxWidth * contentRatio,
        BrnFormUtil.rightArrowLeftPadding + BrnFormUtil.rightArrowSize);
    return maxWidth;
  }
        ...
        child: Row(
          ...
          children: <Widget>[
            Container(
              child: Checkbox(
                value: widget.value,
                activeColor: Color(0xFF8A491E), //选中时的颜色
                onChanged: widget.isEdit
                    ? (value) {
                        BrnFormUtil.notifySwitchChanged(
                            widget.onChanged, context, widget.value, value);
                      }
                    : null,
              ),
            )
      ...
      children: <Widget>[
        Column(
          ...
          children: [
            ...
            Padding(
              padding:
                  EdgeInsets.only(bottom: widget.subTitle != null ? 10 : 0),
              child: BrnFormUtil.buildSubTitleWidget(
                  widget.subTitle, widget.themeData),
            ),
          ],
        ),
